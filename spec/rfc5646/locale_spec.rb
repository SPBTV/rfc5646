RSpec.describe Rfc5646::Locale do
  Locale = Rfc5646::Locale
  ...
  describe '#child_of?' do
    it 'should claim that en-US is a child of en' do
      expect(Locale.from_rfc5646('en-US')).to be_child_of(Locale.from_rfc5646('en'))
    end

    it 'should not claim that ja is a child of en' do
      expect(Locale.from_rfc5646('ja')).not_to be_child_of(Locale.from_rfc5646('en'))
    end

    it 'should claim that zh-cmn-Hans-CN is a child of zh-CN' do
      expect(Locale.from_rfc5646('zh-cmn-Hans-CN')).to be_child_of(Locale.from_rfc5646('zh-CN'))
    end

    it 'should not claim that zh-cmn-Hans-CN is a child of zh-yue-Hans' do
      expect(Locale.from_rfc5646('zh-cmn-Hans-CN')).not_to be_child_of(Locale.from_rfc5646('zh-yue-Hans'))
    end

    it 'should claim that sl-rozaj-biske is a child of sl-rozaj' do
      expect(Locale.from_rfc5646('sl-rozaj-biske')).to be_child_of(Locale.from_rfc5646('sl-rozaj'))
    end

    it 'should not claim that sl-rozaj-biske is a child of sl-nedis' do
      expect(Locale.from_rfc5646('en-rozaj-biske')).not_to be_child_of(Locale.from_rfc5646('sl-nedis'))
    end
  end
end
